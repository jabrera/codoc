			...
			if ($ok == 0) {
				if(isset($_POST['username']) || isset($_POST['password'])) {
					...
					if ((!$myusername) || (!$mypassword)) {
						echo '<a href="login.php"><h3>Log in</h3></a><hr><span class="error">Please fill up the form below.</span><form action="login.php" method="post">
				<center><table width="400px" cellpadding="5">
					...
					<tr>
						...
						if ($count == 1) {
							...
							echo '<a href="login.php"><h3>Log in</h3></a><hr><span class="error">Incorrect username or password. Please try again.</span><form action="login.php" method="post">
				<center><table width="400px" cellpadding="5">
					<tr>
						<td><p>Username</td>
						<td><input type="text" name="username" class="login_text"></td>
					...
					echo '<a href="login.php"><h3>Log in</h3></a><hr><span class="message">Please fill up the form below.</span><form action="login.php" method="post">
				<center><table width="400px" cellpadding="5">
					<tr>
						<td><p>Username</td>
						<td><input type="text" name="username" class="login_text"></td>
