...
<div id="container">
	...
	<div id="content">
		<div id="admin">
			<div id="wrapper">
			<h3><a href="../">Control Panel</a> / <a href="index.php">Tutorials</a> / Delete Tutorial</h3><hr>
			<?php
			if(isset($_GET['id'])) {
				$id = $_GET['id'];
				echo '<p>Are you sure you want to delete this tutorial?</p><br><a href="../process.php?table=posts&action=delete&id='.$id.'">Yes</a> | <a href="index.php">No</a>';
			}
			?>
			</div>
		</div>
